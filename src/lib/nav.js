...
export const navItems = {
  Voter: [
    ...
    { href: "/dashboard/events", label: "Events", labelTa: "நிகழ்வுகள்", icon: Calendar },
  ...
  Admin: [
    ...
    { href: "/dashboard/admin/events", label: "Manage Events", labelTa: "நிகழ்வுகளை நிர்வகி", icon: Calendar },
